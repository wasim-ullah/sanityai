...
export default function AboutValues() {
  const renderIcon = (id) => {
    switch (id) {
      case 'inputs':
        return (
          <svg viewBox="0 0 640 640" className="w-9 h-9 text-[#ffffff] flex-shrink-0" fill="currentColor">
      ...
      case 'love':
        return (
          <svg viewBox="0 0 24 24" className="w-9 h-9 text-[#ffffff] stroke-[1.5] flex-shrink-0" fill="none" stroke="currentColor">
            <circle cx="12" cy="12" r="10" fill="#ffffff" fillOpacity="0.15" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M8 14s1.5 2 4 2 4-2 4-2" strokeLinecap="round" strokeLinejoin="round" />
            <circle cx="9" cy="10" r="1.2" fill="currentColor" stroke="none" />
            <circle cx="15" cy="10" r="1.2" fill="currentColor" stroke="none" />
            <path d="M16.5 5.5a1.2 1.2 0 0 0-1.8 0l-.2.2-.2-.2a1.2 1.2 0 0 0-1.8 1.8l2 2 2-2a1.2 1.2 0 0 0 0-1.8z" fill="#ffffff" stroke="#ffffff" strokeWidth="0.5" />
          </svg>
        );
      default:
        return null;

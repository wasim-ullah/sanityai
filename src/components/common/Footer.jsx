...
export default function Footer() {
  ...
  return (
    <footer className={`relative bg-[var(--color-bg-dark)] w-full overflow-hidden flex flex-col z-10 justify-between ${isCompactFooter
        ? 'h-auto'
      ...
      <div className={`relative z-10 w-full h-auto flex items-center ${isCompactFooter ? 'py-16 lg:py-20' : 'lg:h-[27%] pt-16 pb-12 lg:py-0'
        }`}>
      ...
      <div className={`relative z-10 w-full h-auto flex items-center ${isCompactFooter ? 'py-16 pb-20' : 'lg:h-[25%] py-12 lg:py-0'
        }`}>
        <div className="w-full max-w-[1440px] mx-auto px-6 lg:pl-[105px] lg:pr-[105px] xl:pl-[172px] xl:pr-[172px]">
          ...
          <div className="flex flex-col items-center gap-10 lg:hidden">
            ...
            {/* 3 link columns — horizontal row, auto-width, centered */}
            <div className="flex flex-row justify-center items-start gap-8 sm:gap-12 w-full">
          ...
          <div className="hidden lg:grid w-full grid-cols-12 gap-4 items-start">

...
export default function UnderstandMockup() {
  return (
    <div className="bg-[#0c462e]/30 backdrop-blur-md border border-white/5 p-5 rounded-sm w-[90%] sm:w-[85%] shadow-2xl flex flex-col gap-4">
      {/* Card Header */}
      <div className="flex items-center gap-2.5 pb-3 border-b border-white/5">
        <div className="w-7 h-7 bg-[#2eb87e]/15 border border-[#2eb87e]/30 rounded-sm flex items-center justify-center text-[#2eb87e]">

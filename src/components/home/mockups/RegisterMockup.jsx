...
export default function RegisterMockup() {
  return (
    <div className="w-[90%] sm:w-[85%] flex flex-col items-center gap-3">
      {/* Node 1: Company Info */}
      <div className="bg-[#0c462e]/30 backdrop-blur-md border border-white/5 p-4 rounded-sm w-full flex flex-col gap-2.5 text-[12px] font-sans">
        <div className="flex items-center gap-2 pb-1.5 border-b border-white/5">
          <div className="w-6 h-6 bg-[#2eb87e]/15 border border-[#2eb87e]/30 rounded-sm flex items-center justify-center text-[#2eb87e]">
      ...
      {/* Down Connector */}
      <div className="h-6 w-px bg-[#2eb87e]/30"></div>

      {/* Preparing badge */}
      <div className="bg-[#2eb87e]/15 border border-[#2eb87e]/30 text-[#2eb87e] text-[10px] font-medium tracking-wide uppercase px-3 py-1.5 rounded-sm flex items-center gap-2">
      ...
      <div className="grid grid-cols-2 gap-3.5 w-full">
        {REGISTERED_STATES.map((state, i) => (
          <div key={i} className="bg-[#0c462e]/30 backdrop-blur-md border border-white/5 p-3 rounded-sm flex flex-col gap-2 text-[11px] font-sans">
            <div className="flex items-center gap-1.5">
              <div className="w-4 h-4 bg-[#2eb87e]/10 border border-[#2eb87e]/20 rounded-sm flex items-center justify-center text-[#2eb87e]">
            ...
            <div className="h-1 bg-white/[0.04] w-full rounded-sm overflow-hidden">
              <div className="bg-[#2eb87e]/50 h-full w-[65%]"></div>
            </div>
          </div>
        ))}
      </div>

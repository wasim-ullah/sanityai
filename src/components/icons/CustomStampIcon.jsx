...
// Custom stamp/folder icon matching the provided SVG
export default function CustomStampIcon({ size = 28, strokeWidth = 1.5, fill = 'none', className = '', ...props }) {
  return (
    <svg
      width={size}
      height={size}
      ...
      {...props}
    >
      {/* Document Body Background (only visible when active fill is applied) */}
      <path
        d="M464 96L560 96C586.5 96 608 117.5 608 144L608 496C608 522.5 586.5 544 560 544L464 544C437.5 544 416 522.5 416 496L416 144C416 117.5 437.5 96 464 96z"
        fill={fill}
        className="transition-colors duration-300"
      />
      {/* Outer folder, document card, lines and circles */}
      <path
